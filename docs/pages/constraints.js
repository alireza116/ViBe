    ...
    api: [
        {
            ...
            options: [
                ...
                { name: 'maintainSum.targetSum', type: 'number', default: '—', desc: 'Target total for the field.' },
                { name: 'maintainSum.mode', type: "'cap' | 'normalize' | 'redistribute'", default: "'cap'", desc: '<code class="inline">cap</code> bounds the touched datum (≤ sum); <code class="inline">normalize</code> scales all values to exact sum; <code class="inline">redistribute</code> holds the edited value and proportionally adjusts siblings.' },
                { name: 'normalize', type: 'sugar', default: '—', desc: 'Shortcut for <code class="inline">maintainSum({ mode: "normalize", targetSum: 1 })</code>.' },
                ...
                { name: 'snap.step / origin', type: 'number', default: '—', desc: 'Quantize the field to a grid (slider steps, waffle cells).' },
            ],
