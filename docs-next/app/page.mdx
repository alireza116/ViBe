...
<Lead>VibeJS lets you build charts people can answer with — drag a bar, place a point, turn a dial — and you get structured data back (see the panel next to each chart). Try the questions below.</Lead>
