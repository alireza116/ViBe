...
import Ex5, { meta as ex5Meta, code as ex5Code } from '../../examples/scales/symlog-and-a-diverging-ramp';
...
const examples = {
  ...
  'scales/symlog-and-a-diverging-ramp': { meta: ex5Meta, code: ex5Code, Component: Ex5 },
};
